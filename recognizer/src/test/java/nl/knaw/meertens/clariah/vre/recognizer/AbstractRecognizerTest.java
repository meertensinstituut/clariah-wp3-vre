...
public abstract class AbstractRecognizerTest {
  ...
  String testFitsXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
    ...
    ".org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://hul.harvard.edu/ois/xml/ns/fits/fits_output " +
    "http://hul.harvard.edu/ois/xml/xsd/fits/fits_output.xsd\" version=\"1.2.0\" timestamp=\"1/19/18 1:04 PM\">\n" +
    "  <identification>\n" +
    ...
    "status=\"SINGLE_RESULT\">/tmp/recognizer/test.txt</filepath>\n" +
