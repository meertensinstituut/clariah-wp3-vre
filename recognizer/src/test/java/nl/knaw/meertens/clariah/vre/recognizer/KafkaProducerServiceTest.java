  ...
  public void testProduceCreatesCorrectRecognizerKafkaMsg() throws Exception {
    ...
    assertThat(result.value()).isEqualToIgnoringWhitespace(
      "{" +
        ...
        ".harvard.edu/ois/xml/ns/fits/fits_output\\\" xmlns:xsi=\\\"http://www.w3.org/2001/XMLSchema-instance\\\" " +
        "xsi:schemaLocation=\\\"http://hul.harvard.edu/ois/xml/ns/fits/fits_output http://hul.harvard" +
        ".edu/ois/xml/xsd/fits/fits_output.xsd\\\" version=\\\"1.2.0\\\" timestamp=\\\"1/19/18 1:04 PM\\\">\\n  " +
        "<identification>\\n    <identity format=\\\"Plain text\\\" mimetype=\\\"text/plain\\\" toolname=\\\"FITS\\\"" +
        " toolversion=\\\"1.2.0\\\">\\n      <tool toolname=\\\"Droid\\\" toolversion=\\\"6.3\\\" />\\n      <tool " +
        "toolname=\\\"Jhove\\\" toolversion=\\\"1.16\\\" />\\n      <tool toolname=\\\"file utility\\\" " +
        "toolversion=\\\"5.22\\\" />\\n      <externalIdentifier toolname=\\\"Droid\\\" toolversion=\\\"6.3\\\" " +
        "type=\\\"puid\\\">x-fmt/111</externalIdentifier>\\n    </identity>\\n  </identification>\\n  <fileinfo>\\n  " +
        "  <size toolname=\\\"Jhove\\\" toolversion=\\\"1.16\\\">10</size>\\n    <filepath toolname=\\\"OIS File " +
        "Information\\\" toolversion=\\\"0.2\\\" status=\\\"SINGLE_RESULT\\\">/tmp/recognizer/test.txt</filepath>\\n " +
        "   <filename toolname=\\\"OIS File Information\\\" toolversion=\\\"0.2\\\" status=\\\"SINGLE_RESULT\\\">test" +
        ".txt</filename>\\n    <md5checksum toolname=\\\"OIS File Information\\\" toolversion=\\\"0.2\\\" " +
        "status=\\\"SINGLE_RESULT\\\">b05403212c66bdc8ccc597fedf6cd5fe</md5checksum>\\n    <fslastmodified " +
        "toolname=\\\"OIS File Information\\\" toolversion=\\\"0.2\\\" " +
        "status=\\\"SINGLE_RESULT\\\">1516357453000</fslastmodified>\\n  </fileinfo>\\n  <filestatus>\\n    " +
        "<well-formed toolname=\\\"Jhove\\\" toolversion=\\\"1.16\\\" " +
        "status=\\\"SINGLE_RESULT\\\">true</well-formed>\\n    <valid toolname=\\\"Jhove\\\" toolversion=\\\"1.16\\\"" +
        " status=\\\"SINGLE_RESULT\\\">true</valid>\\n  </filestatus>\\n  <metadata>\\n    <text>\\n      <linebreak " +
        "toolname=\\\"Jhove\\\" toolversion=\\\"1.16\\\" status=\\\"SINGLE_RESULT\\\">LF</linebreak>\\n      <charset" +
        " toolname=\\\"Jhove\\\" toolversion=\\\"1.16\\\">US-ASCII</charset>\\n      <standard>\\n        " +
        ...
        "   </textMD:character_info>\\n        </textMD:textMD>\\n      </standard>\\n    </text>\\n  </metadata>\\n " +
        " <statistics fitsExecutionTime=\\\"128\\\">\\n    <tool toolname=\\\"MediaInfo\\\" toolversion=\\\"0.7" +
        ".75\\\" status=\\\"did not run\\\" />\\n    <tool toolname=\\\"OIS Audio Information\\\" toolversion=\\\"0" +
        ".1\\\" status=\\\"did not run\\\" />\\n    <tool toolname=\\\"ADL Tool\\\" toolversion=\\\"0.1\\\" " +
        "status=\\\"did not run\\\" />\\n    <tool toolname=\\\"VTT Tool\\\" toolversion=\\\"0.1\\\" status=\\\"did " +
        "not run\\\" />\\n    <tool toolname=\\\"Droid\\\" toolversion=\\\"6.3\\\" executionTime=\\\"8\\\" />\\n    " +
        "<tool toolname=\\\"Jhove\\\" toolversion=\\\"1.16\\\" executionTime=\\\"109\\\" />\\n    <tool " +
        "toolname=\\\"file utility\\\" toolversion=\\\"5.22\\\" executionTime=\\\"116\\\" />\\n    <tool " +
        "toolname=\\\"Exiftool\\\" toolversion=\\\"10.00\\\" status=\\\"did not run\\\" />\\n    <tool " +
        "toolname=\\\"NLNZ Metadata Extractor\\\" toolversion=\\\"3.6GA\\\" status=\\\"did not run\\\" />\\n    <tool" +
        " toolname=\\\"OIS File Information\\\" toolversion=\\\"0.2\\\" executionTime=\\\"30\\\" />\\n    <tool " +
        "toolname=\\\"OIS XML Metadata\\\" toolversion=\\\"0.2\\\" status=\\\"did not run\\\" />\\n    <tool " +
        "toolname=\\\"ffident\\\" toolversion=\\\"0.2\\\" executionTime=\\\"34\\\" />\\n    <tool " +
        "toolname=\\\"Tika\\\" toolversion=\\\"1.10\\\" executionTime=\\\"32\\\" />\\n  </statistics>\\n</fits>\\n\"" +
        "}"
    );
