      ...
      response()
        ...
        .withBody(
          "{\n" +
            ...
            "      \"semantics\": \"<cmd:CMD xmlns:cmd=\\\"http://www.clarin.eu/cmd/1\\\" xmlns:cmdp=\\\"http://www" +
            ".clarin.eu/cmd/1/profiles/clarin.eu:cr1:p_1505397653795\\\" xmlns:xs=\\\"http://www.w3" +
            ".org/2001/XMLSchema\\\" xmlns:xsi=\\\"http://www.w3.org/2001/XMLSchema-instance\\\" " +
            "xsi:schemaLocation=\\\"\\n  http://www.clarin.eu/cmd/1 https://infra.clarin.eu/CMDI/1.x/xsd/cmd-envelop" +
            ".xsd\\n  http://www.clarin.eu/cmd/1/profiles/clarin.eu:cr1:p_1505397653795 https://catalog.clarin" +
            ".eu/ds/ComponentRegistry/rest/registry/1.x/profiles/clarin.eu:cr1:p_1505397653795/xsd\\\" " +
            "CMDVersion=\\\"1.2\\\">\\n  <cmd:Header>\\n    <cmd:MdCreationDate>2018-05-28</cmd:MdCreationDate>\\n   " +
            ...
            "<cmdp:ServiceDescriptionLocation/> <!-- test doesn't really run remote -->\\n        " +
            "<cmdp:Operations>\\n          <cmdp:Operation>\\n            <cmdp:Name>main</cmdp:Name><!-- main is our" +
            " default endpoint -->\\n            <cmdp:Input>\\n              <cmdp:Parameter><!-- use Parameter " +
            "instead of ParameterGroup, if there are no nested parameters -->\\n                " +
            "<cmdp:Name>input</cmdp:Name>\\n                <cmdp:MIMEType>text/plain</cmdp:MIMEType>\\n             " +
            " </cmdp:Parameter>\\n            </cmdp:Input>\\n            <cmdp:Output>\\n              " +
