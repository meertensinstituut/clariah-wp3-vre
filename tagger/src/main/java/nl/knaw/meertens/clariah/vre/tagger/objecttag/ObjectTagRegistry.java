...
public class ObjectTagRegistry extends AbstractDreamfactoryRegistry {
  ...
  public Long createObjectTag(ObjectTagDto objectTag) {
    ...
    try {
      ...
      var msg = String
        .format("Could not create object tag with tag [%s], object [%s], owner [%s]", objectTag.params.get("_tag"),
          objectTag.params.get("_object"), objectTag.params.get("_owner"));
  ...
  public Long updateObjectTag(UdateObjectTagDto objectTag) {
    ...
    try {
      ...
      var msg = String
        .format("Could not update object tag with tag [%s], object [%s], owner [%s]", objectTag.params.get("_tag"),
          objectTag.params.get("_object"), objectTag.params.get("_owner"));
      throw new RuntimeException(msg, e);
    }
    try {
