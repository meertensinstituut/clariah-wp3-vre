...
public class Config {
  ...
  public static final String OBJECTS_DB_KEY = requireNonNull(System.getenv("APP_KEY_OBJECTS"));

  // TODO: use shibboleth:
  public static final String TEST_USER = requireNonNull(requireNonNull(System.getenv("TEST_USER")));
